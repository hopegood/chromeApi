...
<<<<<<< HEAD:src/com/chrome/utils/SwitchUtils.java
/*   */
/*   */ public class SwitchUtils
	...
	/*   */   {
		            //System.out.println("findwindow=" + code);
		...
		/* 51 */     else if (code.contains("im")) {
			...
			//System.out.println("查找ob窗體!");
			WinDef.HWND hwnd = findWindowGoogleOr360("FB\u4f53\u80b2");
			User32.INSTANCE.SetForegroundWindow(hwnd);
...
>>>>>>> 84e0c8aeac76ef96a9fa7197232ae47cde7c2034:src/main/java/com/chrome/utils/SwitchUtils.java
